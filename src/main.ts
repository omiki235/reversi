...
import { MoveGateway } from './data-access/move-gateway';
...
app.get('/api/games/latest/turns/:turnCount', async (req, res) => {
  ...
  try {
    ...
    const turnRecord = await turnGateway.findForGmaeIdAndTurnCount(
      conn,
      gameRecord.id,
      turnCount
    );
...
app.post('/api/games/latest/turns', async (req, res) => {
  ...
  try {
    ...
    const previousTurnRecord = await turnGateway.findForGmaeIdAndTurnCount(
      conn,
      gameRecord.id,
      previousTurnCount
    );
